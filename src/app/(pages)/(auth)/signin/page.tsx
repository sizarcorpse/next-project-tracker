...
const SignInPage = () => {
  return (
    <main className="w-full flex items-center justify-center p-0 md:p-6">
      <div className="container max-w-screen-lg flex flex-row items-center justify-center flex-wrap mx-auto bg-slate-900 rounded-none md:rounded-lg">
        ...
        <div className="grow-1 shrink-1 basis-1/1 order-1 md:basis-1/2 md:order-2 md:p-4">
          <Image
            ...
            className="rounded-b-lg aspect-square md:aspect-auto md:rounded-lg xl:aspect-auto"
          />
        </div>
      </div>
    </main>
