  ...
  return (
    <Container>
      <div className="flex flex-row items-start justify-between flex-wrap gap-8 md:flex-nowrap">
        <div className="basis-full flex flex-col gap-6 items-start justify-start p-4 rounded-md md:basis-[296px] bg-card">
          <UserInformation user={user} />
        </div>
        <div className="basis-full flex flex-col gap-4 items-start justify-start bg-card p-4 rounded-md md:basis-[calc(100%-296px-32px)]"></div>
      </div>
    </Container>
  );
};
