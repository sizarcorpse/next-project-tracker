...
const CreateTechnology = () => {
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-screen-md min-h-fit flex flex-col items-start justify-start gap-6 p-4">
        <DialogHeader className="w-full">
          <DialogTitle className="text-xl">Create Technology</DialogTitle>
