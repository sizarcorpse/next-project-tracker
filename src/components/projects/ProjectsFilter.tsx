...
const ProjectsFilter = () => {
  ...
  const handleResetFilterQuery = useCallback(() => {
    const params = new URLSearchParams(searchParams.toString());
    params.delete("type");
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" className="px-3 bg-primary/5 rounded-xl">
          <SlidersHorizontal
              ...
              <DropdownMenuSubContent className="w-48">
                {projectTypes.map((pt) => (
                  <DropdownMenuCheckboxItem
                    ...
                    onCheckedChange={() =>
                      handleProjectsQuery("type", pt.value, true)
                    }
              ...
              <DropdownMenuSubContent className="w-48">
                {projectPriorities.map((pp) => (
                  <DropdownMenuCheckboxItem
                    ...
                    onCheckedChange={() =>
                      handleProjectsQuery("priority", pp.value, true)
                    }
                    className="cursor-pointer"
                  >
                    <div className="flex items-center justify-between gap-2">
              ...
              <DropdownMenuSubContent className="w-48">
                {projectStages.map((ps) => (
                  <DropdownMenuCheckboxItem
                    ...
                    onCheckedChange={() =>
                      handleProjectsQuery("stage", ps.value, true)
                    }
                    className="cursor-pointer"
                  >
                    <div className="flex items-center justify-between gap-2">
